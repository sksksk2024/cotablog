...
const CotaLogoFooter = () => {
  return (
    <motion.svg
      aria-label={`Coța Alexandru's Platform`}
      version="1.0"
      ...
      className="w-96W h-96H mb-16M fill-white hover:fill-warning"
    ...
    >
      ...
      <g
        ...
        className="fill-white hover:fill-warning"
        stroke="none"
      >
        <path
