    ...
    <article className="w-full max-w-container-800 px-16P py-48P mx-auto flex flex-col gap-10 text-white">
      ...
      <section className="space-y-6 text-lg leading-relaxed">
        ...
        <p>
          ...
          market, in someway. I didn't want to do any more physical activities
          in addition to my difficult workouts and going to school. I wanted to
          make money from home. One time, I saw trading as an option, but then
          gave up, because I don't like to spend time learning something just
          for money, but also for my near future business. Then Web Development
          came as my second option.
        </p>
        <p>
          I realised how much you have to pay a web developer, even more than
          any other role in a business, in my oppinion. I didn't want to pay
          someone that much for my business, obviously not in my start of my
        ...
        <p>
          ...
          technologies, that I taught they won't treat my dreams as I want, but
          at the same time, they pushed me faster to my wanted stack. To give
          you some tech examples, they are: MongoDB, Nodejs, Vitest, Docker,
          Vue, CSS, SCSS/SASS, Ruby on Rails, GSAP, ... a lot more.
        </p>
        ...
        <p>
          ...
          the backend. Looking back, this was a misstep: I couldn't learn much,
          I was stuck in so many problems: how to deploy this on github, how to
          make the website cooler looking, how to add multiple functionalities,
          without breaking my head, and the cherry at the top, how to not hope
          that some random JavaScript file worked without knowing why. I didn't
          understand anything: it was a combination with also html, bootstrap
          css classes, and JavaScript, which was a real mess. After a few
          months, I got separated from that violating environment, thinking
          learning the actual basics would help me. My learning path was, and I
          also suggest for those who want to learn how to put fascinating pages
          on the browser: html, css, JavaScript, css frameworks, JavaScript
          frameworks, typescript, then the backend. My path was, for that time,
          a brilliant set of moves that I took, which personally, skyrocketed my
          expectations on making cooler and better websites, overall. At the
          same time, the process got fast and efficient, while facing fewer
          struggles. After this adventure, I didn't come back to the tech that
          my brother uses, since I like my tech stack much more.
        </p>
        <h2 className="text-xl underline">
        ...
        <p>
          ...
          possible. In my case, my goal wasn't to become one of the best in the
          industry, but rather just feeling comfortable with the skill, so I can
          move on to other things to master in these teenage years and that are
          vital, such as communication, writing, and sales.
        </p>
        ...
        <p>
          ...
          limits don't exist, while you can still be awake, energetic and with
          the purpose to finish the work in that specific day. Also, now I have
          lots of opportunities unlocked. Besides being able to create my
